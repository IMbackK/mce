...
MCE_LDFLAGS := $$(pkg-config glib-2.0 gio-2.0 gmodule-2.0 dbus-1 dbus-glib-1 osso-systemui-dbus conic xext --libs)
LIBS := devlock.c tklock.c modetransition.c powerkey.c connectivity.c mce-dbus.c mce-dsme.c mce-rtconf.c event-input.c event-switches.c mce-log.c mce-conf.c datapipe.c mce-modules.c mce-io.c mce-lib.c event-input-utils.c
HEADERS := devlock.h tklock.h modetransition.h powerkey.h connectivity.h mce.h mce-dbus.h mce-dsme.h mce-rtconf.h event-input.h event-switches.h mce-log.h mce-conf.h datapipe.h mce-modules.h mce-io.h mce-lib.h event-input-utils.h
